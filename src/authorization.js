...
//as you're not wrapping this in a method, this will be and endpoint called from Front End.
// to do: connect this to front end using express framework
...
//placeholder for getting the token with client secret in header
// app.get('/login', function (req, res) {
//     res.set({
